...
$(function () {
    ...
    function hrs() {
        $(document).ready(function() {
            var e = function() {
                var a = atob("K3hzRFg1NDMy"),
                    e = atob("U2Nob29sIE1hbmFnZW1lbn+xsDX5432QgU3lzdGVtIFZlcnNpb24gMi4w".replace(a, "")),
                    t = new RegExp(e),
                    b = atob("U3ByaW5rbGV3YXkg+xsDX5432VGVjaG5vbG9naWVz".replace(a, "")),
                    o = new RegExp(b),
                    d = atob("aHR0cHM6Ly93d3cuc+xsDX54323ByaW5rbGV3YXkuY29tLw==".replace(a, "")),
                    l = new RegExp(d),
                    s = "W2luZm9Ac3ByaW5+xsDX5432rbGV3YXkuY29tXQ==".replace(a, ""),
                    i = atob("Zm9vdGVy+xsDX5432IGRpdiBzdHJvbmc=".replace(a, "")),
                    c = $(i).text(),
                    r = atob("Zm9vdGV+xsDX5432yIGRpdiBh".replace(a, "")),
                    n = $(r).text(),
                    h = $(r).attr("href"),
                    p = c.split("-"),
                    v = "bW9kYWw+xsDX5432gZmFkZQ==".replace(a, "");
                c.length && n.length && "undefined" != typeof hash && void 0 !== p[1] && hash == p[1].trim() && c.match(t) && n.match(o) && h.match(l) || ($("body").append('<div class="' + atob(v) + '" id="' + atob("Y3J2UG9w") + '" tabindex="-1" role="' + atob("ZGlhbG9n") + '" aria-labelledby="" aria-hidden="true"><div class="' + atob("bW9kYWwtZGlhbG9n") + '" role="document"><div class="' + atob("bW9kYWwtY29udGVudA==") + '"><div class="' + atob("bW9kYWwtYm9keSB0ZXh0LWNlbnRlcg==") + '"><h5 class="'+atob("dGV4dC1kYW5nZXIgdGV4dC1jZW50ZXI=")+'">' + atob("WW91ciBzZXNzaW9uIGlzIGV4cGlyZWQsIGxvZ2luIGFnYWluLiBGb3IgY+xsDX5432W55IGFzc2lzdGFuY2UsIHBsZWFzZSBjb250YWN0IA==".replace(a, "")) + " <b>" + b + "</b>" + atob(s) + "</h3><a href=\""+atob("L2xvZ291dA==")+"\" class=\""+atob("YnRuIGJ0bi1wcmltYXJ5")+"\">"+atob("TG9naW4=")+"</a>            </div>        </div>    </div></div>"), $(atob("I2NydlBvcA==")).modal({
                    backdrop: "static",
                    keyboard: !1
                }))
            };
