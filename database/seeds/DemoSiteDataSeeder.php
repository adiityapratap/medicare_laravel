...
class DemoSiteDataSeeder extends Seeder
{
    ...
    private function settingsData()
    {
        ...
        $data['name'] = 'SprinkleSchool';
        $data['short_name'] = 'SprinkleSchool';
        $data['facebook'] = '#';
        $data['google'] = '#';
        $data['twitter'] = '#';
        $data['youtube'] = '#';
    ...
    private function contactData()
    {
        ...
        SiteMeta::updateOrCreate(
            ...
            [ 'meta_value' => 'India-560010']
        );
        SiteMeta::updateOrCreate(
            ['meta_key' => 'contact_phone'],
            [ 'meta_value' => '+90-9900136567']
        );
        SiteMeta::updateOrCreate(
            ['meta_key' => 'contact_email'],
            [ 'meta_value' => 'enquiry@sprinkleway.com']
        );
        SiteMeta::updateOrCreate(
            ['meta_key' => 'contact_latlong'],
            [ 'meta_value' => '12.9872864,77.5483043']
        );
    }
    ...
    private function aboutSectionData()
    {
        ...
        $data = [
            ...
            'intro_video_embed_code' => '<iframe src="https://www.youtube.com/embed/EGH8CWlW-zA" frameborder="0" allowfullscreen></iframe>',
    ...
    private function eventData()
    {
        ...
        $data['cover_video'] = '<iframe src="https://www.youtube.com/embed/bVPvTQAqWhU" allowfullscreen></iframe>';
