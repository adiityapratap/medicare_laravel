...
class DemoAppDataSeeder extends Seeder
{
    ...
    private function userData(){
        $created_by = 1;
        $created_at = Carbon::now(env('APP_TIMEZONE','Asia/Kolkata'));
    ...
    private function instituteSettingsData()
    {
        ...
        $data['name'] = 'Sprinkleway School';
        $data['short_name'] = 'SPRLWS';
        $data['establish'] = '2010';
        $data['website_link'] = 'https://erp.sprinkleway.com';
        $data['email'] = 'enquiry@sprinkleway.com';
        $data['phone_no'] = '+91-9900136567';
        $data['address'] = 'Bengaluru, India - 560010';
    ...
    private function teacherData() {
        ...
        $teachers = factory(App\Employee::class, 1)
            ->create(['name' => 'Class Teacher', 'created_by' => $created_by,'created_at' => $created_at]);
    ...
    private function sectionData() {
        ...
        $section = factory(App\Section::class)
            ->create(['class_id'=> 1, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 2, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 3, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 4, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 5, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 6, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 7, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 8, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 9, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 10, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 11, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 12, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);

        $section = factory(App\Section::class)
            ->create(['class_id'=> 13, 'name' => 'A','note' => '', 'created_by' => $created_by,'created_at' => $created_at]);
    }
    ...
    private function subjectData() {
        ...
        $subject = factory(App\Subject::class)
            ->create(['class_id'=> 1, 'type' => 1, 'name' => 'Hindi', 'code' => '110', 'created_by' => $created_by,'created_at' => $created_at]);
