...
mix.js('resources/assets/backend/js/app.js', 'public/js')
    ...
    .js([
        ...
        'resources/assets/backend/js/jquery.justifiedGallery.min.js'
    ], 'public/js/theme.js')
    .extract([
        'jquery', 'bootstrap', 'icheck', 'jquery-validation', 'jquery-slimscroll', 'fastclick', 'fullcalendar',
        'datatables.net', 'datatables.net-bs', 'datatables.net-buttons', 'datatables.net-responsive-bs','lightgallery','lg-thumbnail','lg-autoplay','lg-video','lg-fullscreen','lg-pager','lg-zoom','lg-hash','lg-share','justified-gallery'
    ])        
    ...
    .styles([
        ...
        'resources/assets/backend/css/dropzone.css',
        'resources/assets/backend/css/light-main.css',
        'resources/assets/backend/css/justifiedGallery.min.css',
        'resources/assets/backend/css/lightGallery.css',
        'resources/assets/backend/css/lg-transitions.css',
        'resources/assets/backend/css/dropzone.css',
...
mix.copy(['resources/assets/backend/js/dropzone.js'], 'public/js/dropzone.js');
...
mix.copyDirectory(['resources/assets/backend/js/ckeditor'], 'public/js/ckeditor')
