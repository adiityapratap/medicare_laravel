...
Route::group(
    ...
    // Pre Admissions
    Route::get('/admission', 'HomeController@preAdmission')->name('site.preAdmission');
    Route::post('/preAdmissionForm', 'HomeController@preAdmissionForm')->name('site.preAdmissionForm');
    Route::get('/getStudentDetails', 'HomeController@getStudentDetails')->name('site.getStudentDetails');
    // Pre Admissions
});
